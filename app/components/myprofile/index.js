        ...
        <View style={{flex:1}}>
          ...
          <View style={styles.detailSection}>
              <View style={{flexDirection:'row',marginLeft:20,marginTop:5,marginBottom:5}}>
                ...
                <Text style={{paddingLeft:20}} onPress={() =>  this.props.navigation.navigate('EditProfile')}>Edit Profile</Text>
              </View>
              <View style={{flexDirection:'row',marginLeft:20,marginTop:5,marginBottom:5}}>
                <Image source={require('../images/location_icon.png')} style= {styles.imageFooter} />
                <Text style={{paddingLeft:20}} onPress={() =>  this.props.navigation.navigate('MyCredits')}>My Credits</Text>
              </View>
              <View style={{flexDirection:'row',marginLeft:20,marginTop:5,marginBottom:5}}>
                <Image source={require('../images/car.png')} style= {styles.imageFooter} />
                <Text style={{paddingLeft:20}} onPress={() =>  this.props.navigation.navigate('MyBookings')}>My Bookings</Text>
              </View>
              <View style={{flexDirection:'row',marginLeft:20,marginTop:5,marginBottom:5}}>
                <Image source={require('../images/key.png')} style= {styles.imageFooter} />
                <Text style={{paddingLeft:20}} onPress={() =>  this.props.navigation.navigate('MyBalance')}>My Balance</Text>
              </View>
              <View style={{flexDirection:'row',marginLeft:20,marginTop:5,marginBottom:5}}>
