            ...
            <View style={styles.container}>
                <View style={styles.detailSection}>
                    <View style={{flexDirection: 'row'}}>
                        ...
                        <View style={{
                            marginLeft: 20, backgroundColor: '#fccb32', width: 50,
                ...
                <View style={styles.section6}>
                    ...
                    <View style={styles.section6Inner}>
                        <Text style={{marginLeft: 0}} onPress={() => this.props.navigation.navigate('EditProfile')}>My
                            Profile</Text>
                        <Text style={{marginLeft: 0}} onPress={() => this.props.navigation.navigate('MyCredits')}>My
                            Credits</Text>
                        <Text style={{marginLeft: 0}}
                              onPress={() => this.props.navigation.navigate('MyRide')}>Dashboard</Text>
                        <Text style={{marginLeft: 0}} onPress={() => this.props.navigation.navigate('Settings')}>My
                            Balance</Text>
