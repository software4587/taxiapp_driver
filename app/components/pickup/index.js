                    ...
                    this.state.fontLoaded ? (
                        <View style={styles.detailSection}>
                            <View style={{flexDirection: 'row'}}>
                                <Text style={{marginLeft: 20, fontFamily: 'GothamBold', fontSize: 20}}>Scarlet
                                    Johnson</Text>
                                ...
                                <View style={{
                                    ...
                                    <Image source={require('../images/star_white.png')}
