...
export default class MyCredits extends Component
{
  ...
  render()
  {
    return (
      ...
      <Header name="MY CREDITS" />
      <View style={{flex:1}}>
          <View style={styles.withdrawSection}>
            <Text style={{fontSize:35,}}>1,258</Text>
            <Text style={{fontWeight:'bold'}}>Total Available Credit</Text>
            ...
            width: 170, borderRadius:10,alignItems:'center', justifyContent:'center',marginTop:5}}>
              <Text style={{fontSize:10,fontWeight:'bold'}}>BUY CREDITS</Text>
            </TouchableOpacity>
          </View>

          <View style={styles.historyTitle}>
            <Text style={{fontSize:10,fontWeight:'bold', marginLeft:10}}>CREDIT HISTORY</Text>
          </View>

          <View style={styles.detailSection}>
              <Text style={{fontWeight:'bold',fontSize:40,color:'#d8d8d8'}}>1</Text>
              <View>
              <Text style={{marginLeft:20}}>Credits added</Text>
