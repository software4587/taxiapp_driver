            ...
            <View style={styles.container}>
                ...
                <View style={{flex: 1}}>
                    ...
                    <View style={styles.historyTitle}>
                        <Text style={{fontSize: 10, fontWeight: 'bold', marginLeft: 10, fontFamily: "GothamBold"}}>CREDIT
                            HISTORY</Text>
                    </View>
                    ...
                    <View style={styles.detailSection}>
                        ...
                        <View>
                            ...
                            <Text style={{marginLeft: 20, color: 'gray', fontSize: 10, fontFamily: "GothamBook"}}>DATE:
                                12 Aug, 2018</Text>
                        </View>
