                ...
                {/*<ScrollView>*/}
                    ...
                    </View>
                    {
                        this.state.fontLoaded ? (
                            <View style={styles.section1}>
                                <Text style={{fontSize: 22, fontFamily: 'GothamBold', color: '#FFFFFF'}}>Complete
                                    Registration </Text>
                                <Text style={{fontSize: 15, fontFamily: 'GothamBook', color: '#FFFFFF'}}>Please complete
                                    your registration here</Text>
                            </View>
                        ) : null
                    }
                    ...
                    <View style={styles.regContainer}>
                        ...
                        <View style={styles.section2}>
                            <TouchableOpacity onPress={() => this.props.navigation.navigate('MyProfile')} style={{
